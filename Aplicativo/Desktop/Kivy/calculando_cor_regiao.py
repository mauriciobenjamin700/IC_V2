...
def dados_imagem_unica(path,nome_imagem):
    diretorio_imagens = lista_local_img(path=path)

    

    if f'{path}\{nome_imagem}.jpg' in diretorio_imagens:
        ...
        imagem_BGR = cv2.imread(f'{path}\{nome_imagem}.jpg')
